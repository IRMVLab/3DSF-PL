...
class KittiDataset(torch_data.Dataset):
    def __init__(self, root_dir, split='train0'):
        self.split = split
        is_test = self.split == 'training'
        self.imageset_dir = root_dir

        #split_dir = os.path.join(root_dir, 'KITTI', 'ImageSets', split + '.txt')
        split_dir = root_dir +'/split/train.txt'
        ...
        self.label_dir = os.path.join('/dataset/data_odometry_color/sequences/00', 'label_2')
    ...
    def get_depth(self, idx):
        ...
        #depth_file = '/dataset/data_odometry_color/sequences/02/depth_map/000000.npy'
    ...
    def get_road_plane(self, idx):
        plane_file = os.path.join(self.plane_dir, '%010d.txt' % idx)

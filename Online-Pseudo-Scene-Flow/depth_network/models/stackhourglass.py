...
class PSMNet(nn.Module):
    ...
    def forward(self, left, right, calib, out_std=False, out_cost_volume=False):
        ...
        #pred3_out.size() torch.Size([2, 384, 1248])

        '''
        pred3_out tensor([[[8.5832, 8.5832, 8.6264,  ..., 4.8673, 4.8905, 4.8905],
         [8.5832, 8.5832, 8.6264,  ..., 4.8673, 4.8905, 4.8905],
         [8.5617, 8.5617, 8.5986,  ..., 4.9752, 5.0058, 5.0058],
         ...,
         [5.9701, 5.9701, 5.9864,  ..., 5.8360, 5.8000, 5.8000],
         [5.9502, 5.9502, 5.9683,  ..., 5.8144, 5.7791, 5.7791],
         [5.9502, 5.9502, 5.9683,  ..., 5.8144, 5.7791, 5.7791]],

        [[8.3493, 8.3493, 8.2736,  ..., 4.6430, 4.6919, 4.6919],
         [8.3493, 8.3493, 8.2736,  ..., 4.6430, 4.6919, 4.6919],
         [8.3154, 8.3154, 8.2450,  ..., 4.6912, 4.7476, 4.7476],
         ...,
         [5.7782, 5.7782, 5.7862,  ..., 5.4996, 5.4588, 5.4588],
         [5.7624, 5.7624, 5.7725,  ..., 5.4917, 5.4514, 5.4514],
         [5.7624, 5.7624, 5.7725,  ..., 5.4917, 5.4514, 5.4514]]],

...
# Camera intrinsics and extrinsics C0:
#self.fu, self.fv, self.cu, self.cv = 868.993378, 866.063001, 525.942323, 420.042529
# Camera intrinsics and extrinsics C1:
# self.fu, self.fv, self.cu, self.cv = 873.382641, 876.489513, 529.324138, 397.272397
...
def fliter_radius(pc_data):
            ...
            cl, ind = pcl.remove_statistical_outlier(nb_neighbors=8, std_ratio=1.8)

...
if __name__ == '__main__':
    ...
    parser.add_argument('--validate-every', '--validate_every', default=10000, type=int, help='validation period')
    ...
    parser.add_argument("--resume", default='pretrained/AdaBins_kitti.pt', type=str, help="Resume from checkpoint")
    ...
    parser.add_argument("--data_path", default='../../dataset/KITTI/raw/', type=str,
                        help="path to dataset")
    parser.add_argument("--gt_path", default='../../dataset/KITTI/data_depth_annotated/train', type=str,
                        help="path to dataset")
    ...
    parser.add_argument('--data_path_eval',
                        default="../../dataset/KITTI/raw/",
                        type=str, help='path to the data for online evaluation')
    parser.add_argument('--gt_path_eval', default="../../dataset/KITTI/data_depth_annotated/val",

...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', '--save_dir', default='test_imgs/depthmap', type=str, help='Store predictions in folder')
    ...
    parser.add_argument('--checkpoint_path', default='pretrained/AdaBins_kitti.pt', type=str,
